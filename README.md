...
| 结论 | 条件 | 含义 | 操作建议 |
|------|------|------|----------|
| **洗盘吸筹** | 表面偏空 + 暗盘偏多 | 大户打压价格吸货，散户恐慌卖出 | 可以关注! 冰山买单撑底 |
| **诱多出货** | 表面偏多 + 暗盘偏空 | 大户拉高出货，散户追涨接盘 | 不要追高! 隐藏卖压巨大 |
| **真实下跌** | 表面偏空 + 暗盘偏空 | 都在卖，不是洗盘是真跌 | 不要抄底! 等冰山买单出现 |
| **真实上涨** | 表面偏多 + 暗盘偏多 | 都在买，趋势确认 | 可以买入! 冰山买单支撑 |
| **暗中吸筹** | 表面中性 + 暗盘偏多 | 表面平静，大户悄悄建仓 | 可以关注! 大户在悄悄买 |
| **暗中出货** | 表面中性 + 暗盘偏空 | 表面平静，大户悄悄出货 | 小心! 大户在悄悄卖 |
| **多空博弈** | 表面中性 + 暗盘中性 | 买卖力量均衡，等待方向 | 观望，等待一方胜出 |
...
**表面信号来源:**
- 综合分数 (0-100): ≥60偏多, ≤35偏空
- MTF趋势: 1D/4H/15M 的MA5 vs MA10
- 鲸鱼流: 单笔>$10,000的交易累计
- 散户流: 小额交易方向

**暗盘信号来源:**
- 冰山买单: 订单簿补单行为检测到的隐藏买入
- 冰山卖单: 订单簿补单行为检测到的隐藏卖出
- 买卖比: 冰山买单数/总冰山单数, >0.55偏多, <0.45偏空
